 ...
 */
namespace codicastudio\UserVerification;
...
use codicastudio\UserVerification\Events\UserVerified;
use codicastudio\UserVerification\Events\VerificationEmailSent;
use codicastudio\UserVerification\Exceptions\ModelNotCompliantException;
use codicastudio\UserVerification\Exceptions\TokenMismatchException;
use codicastudio\UserVerification\Exceptions\UserHasNoEmailException;
...
use codicastudio\UserVerification\Mail\VerificationTokenGenerated;
...
class UserVerification
{
     ...
     * @return bool
     *
     * @throws \codicastudio\UserVerification\Exceptions\ModelNotCompliantException
     */
     ...
     * @return stdClass
     *
     * @throws \codicastudio\UserVerification\Exceptions\UserNotFoundException
     */
     ...
     * @return void
     *
     * @throws \codicastudio\UserVerification\Exceptions\UserIsVerifiedException
     */
     ...
     * @return void
     *
     * @throws \codicastudio\UserVerification\Exceptions\TokenMismatchException
     */
