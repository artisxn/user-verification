...
class UserVerificationServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // views
        $this->loadViewsFrom(__DIR__ . '/resources/views', 'user-verification');

        $this->publishes([
                __DIR__ . '/resources/views' => resource_path('views/vendor/user-verification'),
            ], 'views');

        // translations
        $this->loadTranslationsFrom(__DIR__ . '/resources/lang', 'user-verification');

        $this->publishes([
            __DIR__ . '/resources/lang' => resource_path('lang/vendor/user-verification'),
        ], 'translations');
